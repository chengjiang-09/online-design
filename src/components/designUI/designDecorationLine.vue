      ...
      >
        <div
          ...
          :style="{
            ...
            animationDuration: `${styleData.animationTime}s`,
            animationTimingFunction: styleData.animationTimingFunction,
            opacity: styleData.opacity,
            height: `${styleData.lineWidth}px`,
          }"
        ></div>
      </SelectComponent>
      <div
...
.design-decoration-line {
  ...
  .box {
    ...
    .line {
      ...
      top: 50%;
      left: 0;
      animation: stretchLine 2s linear infinite;
    }
